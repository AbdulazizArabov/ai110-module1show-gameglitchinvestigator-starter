...
- What is one habit or strategy from this project that you want to reuse in future labs or projects?
  Answer: Writing tests for my functions in the future.

  - This could be a testing habit, a prompting strategy, or a way you used Git.
  Answer: Yes, I want to make the usage of Tests, prompting strategy. I have alredy been using Git for quite a while.

- What is one thing you would do differently next time you work with AI on a coding task?
  Answer: I would work on it faster as I have experienced fixing bugs with artificial intelligence.

- In one or two sentences, describe how this project changed the way you think about AI generated code.
  Answer: Exploration of AI assistance in fixing bugs and writing missing components was a very big boost in efficiency.
